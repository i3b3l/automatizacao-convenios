        ...
        while preparando_pagamento == True:
            ...
            if ja_foi_liquidado == True:
                ...
                if ja_foi_preparado == False:
                    ...
                    data_referencia_preencher = pp_despesa_empenhada.locator("#txtDataReferencia_SIGEFData")
                    data_referencia_preencher.press("Backspace")
                    data_referencia_preencher.press_sequentially(data_do_pagamento)
